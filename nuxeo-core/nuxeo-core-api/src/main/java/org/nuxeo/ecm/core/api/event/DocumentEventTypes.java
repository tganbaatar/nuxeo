...
public final class DocumentEventTypes {
     ...
     * <p>
     * The event's options map contains {@link CoreEventConstants#LEGAL_HOLD} set to {@code true}.
     *
     * @since 11.1
     */
     ...
     * <p>
     * The event's options map contains {@link CoreEventConstants#LEGAL_HOLD} set to {@code false}.
     *
     * @since 11.1
     */
